...
public class SnowflakeUtils {
     ...
     * 起始时间戳
     **/
    private final static long START_TIME = 1451606400000L;
    ...
    public SnowflakeUtils(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public SnowflakeUtils(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
